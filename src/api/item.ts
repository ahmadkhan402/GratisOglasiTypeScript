...
// const getMakeBycategory = async (cate, subCate) => {
//   try {
...
// const getModel = async (subCategory, make) => {
//   try {
...
// const getTypeBycategory = async (category, subCategory) => {
//   try {
...
// const viewItem = async (itemId, userId) => {
//   try {
//     let response = await fetch(
